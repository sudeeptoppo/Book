...
app.get("/testListing", async (req, res) => {
    const sampleListing = new bookListing({
        ...
        image: "https://images.unsplash.com/photo-1589998059171-988b97c09c9d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        price: 10,
        rating: 4.5
    })
...
app.post("/init", async (req, res) => {
    ...
    res.send("All listings inserted successfully");
})
